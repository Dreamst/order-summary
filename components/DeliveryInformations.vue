<template>
  <div class="delivery-informations">
      <h2 class="title uppercase my-30 text-center">Informations sur la livraison</h2>

      <div class="delivery-informations__content bg-white box-shadow flex flex-row p-20">
        <div class="p-20">
